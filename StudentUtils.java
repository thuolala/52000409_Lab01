...
public class StudentUtils {
    ...
    public static void sortByName(List<Student> list) {
        Collections.sort(list,
            ...
            { return Integer.signum(o1.name.compareTo(o2.name)); }
        );
    }
    ...
    public static void sortByAgeDescending(List<Student> list)
    {
        Collections.sort(list,
                (Student o1, Student o2) ->
                { return Integer.signum(o2.age - o1.age); }
        );
    }
    ...
    {
        List<Double> averageL = list.stream()
        .map(s -> s.average())
        .collect(Collectors.toList());
        double average = averageL.stream().mapToDouble(Double::doubleValue).sum();
        return average;
    }
